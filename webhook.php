...
$apiKey = '7997377697:AAGFkBhDkruPgGEQtoEj2ib2ztY5GDW327Y'; // Your Telegram bot API key
...
if ($text === '/start') {
    ...
    $caption = "
    👋 **Welcome to the APO11O Adventure!** 🐾🎮

    Get ready for a tail-wagging journey where every paw-tap leads to bigger rewards! Here’s what’s waiting for you:

    ✨ **Play APO11O**: Tap the dog bone and watch your balance fetch amazing rewards!
    🐕 **Mine for PUPS**: Collect APO11O Tokens with every action your furry friend takes.
    ...
    🐾 **Get Started Now** and take your dog on the ultimate APO11O adventure!

    👉 [Join Our Doggo Community](https://t.me/apo11ocomm)
    ";
    ...
    $post_fields = [
        ...
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                [
                    ['text' => 'Play APO11O Now', 'web_app' => ['url' => 'https://apo11o-bot.vercel.app/']],
                    ['text' => 'Join Our Community', 'url' => 'https://t.me/apo11ocomm']]
            ]
        ])
    ];
